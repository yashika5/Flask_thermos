...
#def logged_in_user():
#	return User.query.filter_by(username='yashika').first()
...
def add():
	...
	if form.validate_on_submit():
		...
		flash("'{}' Stored '{}'".format(bm.user.username, description))
...
def edit_bookmark(bookmark_id):
	...
	if form.validate_on_submit():
		...
		db.session.commit()
		flash("'{}' Stored '{}'".format(bookmark.user.username, bookmark.description))
...
def delete_bookmark(bookmark_id):
	...
	if request.method == "POST":
		...
		db.session.commit()
		flash("'{}' Deleted '{}'".format(bookmark.user.username, bookmark.description))
		return redirect(url_for('user', username=current_user.username))
	else:
